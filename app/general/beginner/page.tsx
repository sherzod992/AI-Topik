/**
 * 한국어 일반 수업 - 초급 페이지 (/general/beginner)
 * 초급 레벨 수업 목록을 표시합니다.
 */
...
export default async function BeginnerPage() {
  // 이 페이지에서 호출할 API: getGeneralLessons('beginner')
  const lessons = await getGeneralLessons('beginner');

  return (
    <CenterStage>
      <div className="flex flex-col items-center justify-center gap-6 w-full">
        <h1 className="text-2xl sm:text-3xl font-bold text-white mb-4">초급 수업</h1>
        {/* TODO: lessons 목록 렌더링 */}
